...
} from "./desktop/sites/chart/parts/chart-settings/organization-chart-settings/organization-chart-settings.component";
import {
  OrganizationChartSelectedUserBoxComponent
} from "./desktop/sites/chart/parts/chart-selected-user/organization-chart-selected-user-box/organization-chart-selected-user-box.component";
import {
  OrganizationChartSettingsOptionsComponent
} from "./desktop/sites/chart/parts/chart-settings/organization-chart-settings-options/organization-chart-settings-options.component";
import {SwitchComponent} from "./desktop/components/switch/switch.component";
import {
  OrganizationChartSelectedUserBoxContentComponent
} from "./desktop/sites/chart/parts/chart-selected-user/organization-chart-selected-user-box-content/organization-chart-selected-user-box-content.component";
import {
